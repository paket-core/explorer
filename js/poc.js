...
$(document).ready(function(){
    ...
    $('#createPackage #tryItOut').click(function(){
        ...
        const data = {
            ...
            payment_buls: parseInt($(selectorPanel + '#paymentBuls').val(), 10) * BUL_TO_STROOP,
            collateral_buls: parseInt($(selectorPanel + '#collateralBuls').val(), 10) * BUL_TO_STROOP,
